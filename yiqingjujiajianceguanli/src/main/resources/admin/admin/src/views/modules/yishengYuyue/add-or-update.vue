    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.yishengYuyueTime"  class="input" label="预约时间" prop="yishengYuyueTime">
                        <el-date-picker
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoText" label="治疗方案" prop="yishengYuyueYesnoText">
