        ...
        <el-dialog title="审核" :visible.sync="yishengYuyueYesnoTypesVisible">
            <el-form :model="form">
                ...
                <el-form-item label="治疗方案">
                    <el-input type="textarea" v-model="form.yishengYuyueYesnoText" placeholder="治疗方案"></el-input>
                </el-form-item>
            </el-form>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiqingjujiajianceguanli/upload/yishengYuyueMuBan.xls"
                        >批量导入医生预约数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('yishengYuyue','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        ...
                        types : 'yisheng_yuyue_yesno_types',//分组下拉框字段
                    },
                    joinTable : {//级联表（可以不存在）
                        tableName :'yisheng',//级联表表名
            ...
            yishengYuyueYesnoTypesShenhe() {
                ...
                if(_this.form.yishengYuyueYesnoText == null || _this.form.yishengYuyueYesnoText == ""){
                    _this.$message.error("请输入治疗方案");return false;
                }
                this.$http({
