...
var centerMenu = [
    ...
    ,{
        name: '知识收藏',
        url: '../zhishiCollection/list.html'
    }
    ,{
        name: '知识留言',
        url: '../zhishiLiuyan/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '健康小知识',
        url: './pages/zhishi/list.html'
    },

]

// 已废弃,不用了
var adminurl =  "http://localhost:8080/yiqingjujiajianceguanli/admin/dist/index.html#/login";
