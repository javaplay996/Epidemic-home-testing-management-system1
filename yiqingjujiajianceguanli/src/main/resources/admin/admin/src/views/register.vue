    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">疫情居家检测管理系统注册</h1>
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="科室" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengTypes" autocomplete="off" placeholder="科室"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        <!--
                            <el-form-item label="职称" class="input" v-if="tableName=='yisheng'">
                                <el-input v-model="ruleForm.yishengZhichneg" autocomplete="off" placeholder="职称"  />
                           </el-form-item>
                        -->
                        <!--
                        ...
                        <!--
                            <el-form-item label="个人介绍" class="input" v-if="tableName=='yisheng'">
                                <el-input type="textarea" v-model="ruleForm.yishengContent" placeholder="个人介绍"></el-input>
                           </el-form-item>
                        -->
                        <!--
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            // yisheng 中的 科室 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengTypes== null ||this.ruleForm.yishengTypes== "")){
                            ...
                            // }
                            // yisheng 中的 职称 判空处理
                            // if('yisheng' == this.tableName && (this.ruleForm.yishengZhichneg== null ||this.ruleForm.yishengZhichneg== "")){
...
<style lang="scss" scoped>
	...
	.container {
		...
		background-image: url(/yiqingjujiajianceguanli/img/back-img-bg.jpg);
